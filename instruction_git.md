...
Это облачное хранилище, в котором могут храниться файлы отправленные из локального репозитория. Также можно сделать свой удалённый коммит публичным или приватным.
